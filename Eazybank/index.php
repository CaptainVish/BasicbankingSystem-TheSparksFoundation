...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid" >
            <a class="navbar-brand" href="#">EAZY BANK<img src="logos/logo.webp" alt="Bank" width="50" height="50"></a>
    ...
    <class class="welcome">
        <h2 style="color:black">
            <img src="logos/friend.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Money Transfer Made Easy with EAZY</strong> <img src="logos/trust.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="background/bg1.png" width="1000" height="375" class="d-block w-100" alt="...">
            ...
            <div class="carousel-item">
                <img src="background/bg3.jpg" width="1000" height="375" class="d-block w-100" alt="...">
                ...
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static" >
                        <div id="hover1"><strong class="d-inline-block mb-5 text-dark text-center">
                                <a href="money.php">
                                    <h6 style="color:black"><strong>Money Transfer</strong></h6>
                                </a>
                            </strong></div>
                        <h5 class="mb-2" style="margin: 10px;"></h5>
                        <p class="card-text mb-auto mb-2">
                        <div class="service">
                            <ul>
                                <li>Personal Banking</li>
                                <li>Hassle free transfer</li>
                ...
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                        <div id="hover2"><strong class="d-inline-block mb-5 text-dark text-center">
                                <a href="history.php">
                                    <h6 style="color:black"><strong>Transaction History</strong></h6>
                                </a>
                            </strong></div>
                        <h5 class="mb-2" style="margin: 10px;"></h5>
                        <p class="card-text mb-auto mb-2">
    ...
    <div class="foot">
        <footer class="bg-light text-center text-lg-start">
            ...
            <div class="text-center p-3" style="background-color:grey" >
                © 2021 Copyright - Made by Vishwajeeth P :
